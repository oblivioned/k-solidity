...
export default class KSolidityViewWelcome extends ScrollView {
    constructor(uri) {
        super();
        // 实例化事件监听器，用于监听和触发事件
    ...
    // 视图html
    static content() {
        // this.div 方法将会创建一个包含参数指定属性的 div 元素，可以换成其他 html 标签，eg: this.section()将创建 section 标签元素
        return this.div({class: 'k-solidity-welcome', otherAttributeName: 'value'});
    }

    // 自定义方法，用户可自定义视图中展示的内容, 具体可查看 Element-Helper 源码
    setView(args) {
        this.title_ = "KSolidity IDE Welcome";
